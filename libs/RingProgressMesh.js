...
void main (void)
{
  ...
  // Calculate the circle and arc contributions to the final color
  float circleValue = circle(vUv, center, 0.5);
  float arcValue = arc(vUv, center, 0.4, uProgress);

  // Mix the colors based on the contributions
  color = mix(bgColor, arcColor, arcValue); // Mix between brown and orange based on arc value
  color *= circleValue; // Apply circle mask
